...
public class AntColony_a {
    ...
    public AntColony_a(double[][] distances, int numAnts, double decay, double alpha, double beta) {
    ...
    public static void main(String[] args) {
        ...
        AntColony_a antColony = new AntColony_a(distances, numAnts, decay, alpha, beta);
